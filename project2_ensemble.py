...
for ds_cnt, ds in enumerate(datasets):
    #preprocess datasets split into training test split
    X,y =ds
    ...
    for name, clf in zip(names,classifiers):
        ...
        ax.scatter(X_test[:,0],X_test[:,1], c=y_test, cmap=cm_bright,marker="^",edgecolors="white",
                   alpha=0.6)
...
print("Dataset # 2")
make_classify(data_classificaiton,classifiers,names)
